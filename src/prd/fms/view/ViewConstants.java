...
public class ViewConstants {
	...
	public static final String RENAME_EXIST_MSG = "Input file/folder has existed.";
	...
	public static final int RIGHT_PANEL_HGAP = 5;
	public static final int RIGHT_PANEL_VGAP = 5;
